...
en = {
    "RUNNING_LOCALLY": "сервер поднят",
    "RUNNING_LOCALLY_SEPARATED": "сервер поднят",
    "SHARE_LINK_DISPLAY": "{}",
    "COULD_NOT_GET_SHARE_LINK": "\nПроблемы с интернетом, ссылку создать не получилось. Используй одну из ссылок выше, например на ngrok\n",
